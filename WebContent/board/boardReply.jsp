...
<body>
	<%
	 	session.setAttribute("command", "board_reply");  // multipart/form-data때문에 세션을 통해 커맨드 전송
	%>
		...
		<form name="frm" method="post" action="BoardServlet" enctype="multipart/form-data">
			...
			<table id="list">
				...
				<tr>
					...
					<td><input type="text" size="70" name="title" value="└─>[Re] ${board.title} "> * 필수</td>
				</tr>
				<tr>
			...
			<br> <input type="submit" value="등록" onclick="return boardCheck()"> 
				...
				<input type="button" value="목록" onclick="location.href='BoardServlet?command=board_list&page=1'"> <br><br>
		</form>
	</div>
</body>
</html>